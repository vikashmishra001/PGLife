...
$user_id = isset($_SESSION['user_id']) ? $_SESSION['iser_id'] : null;
$property_id = $_GET["property_id"];

$sql_1 = "SELECT *, p.id as property_id, c.name as city_name from properties p 
...
$property = MYSQLI_ASSOC($result_1);
if(!$property){
    echo "something is wrong";
    return;
}
...
$testimonials = mysqli_fetch_assoc($result_2, MYSQLI_ASSOC);
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="https://th.bing.com/th/id/OIP.Ro5RqMqVThDqXlW79iSNNQHaEU?rs=1&pid=ImgDetMain">
            </div>
            ...
            <div class="testimonial-name">- virat kohli</div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="https://biografiacorta.net/wp-content/uploads/2022/01/Rohit-Sharma-1536x1536.jpg">
            </div>
            <div class="testimonial-text">
                <i class="fa fa-quote-left" aria-hidden="true"></i>
                <p>You just have to arrive at the place, it's fully furnished and stocked with all basic amenities and services and even your friends are welcome.</p>
